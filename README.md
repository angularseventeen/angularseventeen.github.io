...
main.js             | main          | 193.37 kB |                52.79 kB
polyfills.js        | polyfills     |  32.69 kB |                10.59 kB
styles.css          | styles        |   0 bytes |                 0 bytes

                    | Initial total | 226.06 kB |                63.38 kB

Output location: /home/kushal/src/angular/angularseventeengithubio/docs

Application bundle generation complete. [4.799 seconds]
Done in 5.47s.
```
```bash
```
Thu Feb 15 05:09:06 PM EST 2024
yarn version v1.22.21
info Current version: 0.0.281
info New version: 0.0.282
Done in 0.12s.
