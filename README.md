...
main.js             | main          | 194.55 kB |                53.09 kB
polyfills.js        | polyfills     |  32.69 kB |                10.59 kB
styles.css          | styles        |   0 bytes |                 0 bytes

                    | Initial total | 227.25 kB |                63.68 kB

Output location: /home/kushal/src/angular/angularseventeengithubio/docs

Application bundle generation complete. [4.824 seconds]

Done in 5.51s.
```
```bash
```
Sun Mar 17 10:31:08 AM EDT 2024
yarn version v1.22.22
info Current version: 0.0.355
info New version: 0.0.356
Done in 0.11s.
